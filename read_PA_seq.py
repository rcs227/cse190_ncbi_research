...
def stream_PA_local_id_list(id_file_path, max_to_process=None):
    ...
    output_csv = "PA_local_ids_summary.csv"
...
stream_PA_local_id_list("PA_nucleotide_genomes.txt", max_to_process=10)